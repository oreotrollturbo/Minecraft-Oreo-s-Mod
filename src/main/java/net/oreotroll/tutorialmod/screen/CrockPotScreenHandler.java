...
public class CrockPotScreenHandler extends ScreenHandler {
    ...
    public final CrockPotBlockEntity blockEntity;

    public CrockPotScreenHandler(int syncId, PlayerInventory inventory, PacketByteBuf buf){
    ...
    public CrockPotScreenHandler(int syncId, PlayerInventory playerInventory,
        ...
        super(ModScreenHandlers.CROCK_POT_SCREEN_HANDLER_SCREEN_HANDLER, syncId);
