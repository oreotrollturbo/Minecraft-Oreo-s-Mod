...
public class CrockPotScreen extends HandledScreen<CrockPotScreenHandler> {
    ...
    private static final Identifier TEXTURE = new Identifier(TutorialMod.MOD_ID, "textures/gui/crock_pot_gui.png");
    ...
    protected void init() {
        super.init();
        titleY = 1000; //basically removes the player inventory title
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        RenderSystem.setShaderColor(1f,1f,1f,1f); //might mess around with this see what happens
